<?php 
    ...
    if($_POST){
        ...
        $destaque_produto = $_POST['destque_produto'];
    ...
    $lista = $conn -> query("select * from tbprodutos where id_produto = id_produto");
                    ...
                    <div class="alert alert-danger" role="alert">
                        <form action="produtos_insere.php" method="post" name="form_produto_insere" enctype="multipart/form-data" id="form_produto_insere" >
                            ...
                            <label for="destaque_produto">Destaque:</label>
                                        <div class="input-group">
                                            <label type="radio" for="destaque_produto_s" class="radio-inline">
                                            <input type="radio" name="destaque_produto" id="destaque_produto" value="sim" <?php echo $row['destaque_produto']=="Sim"?"checked":null ?>  >Sim
                                        </label>
                                            <label type="radio" for="destaque_produto_n" class="radio-inline">
                                            <input type="radio" name="destaque_produto" id="destaque_produto" value="nao" checked<?php echo $row['destaque_produto']=="Sim"?"checked":null ?>>Não
                                        </label>
                                        </div>
                            <label for="destaque_produto">Decrição:</label>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                            ...
                                            maxlength="100" required value="<?php echo $row['descri_produto'];?>">
                                        </div>
                            ...
                            <label for="valor_produto">Valor:</label>
                                        <div class="input-group">
                                            ...
                                            class="form-control" 
                                            required min="0" step="0.1"value="<?php echo $row['valor_produto'];?>">
                                        </div>
