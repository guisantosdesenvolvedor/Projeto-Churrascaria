                    ...
                    <div class="alert alert-danger" role="alert">
                        ...
                        id="form_produto_insere">
                            ...
                            <div class="input-group">
                                ...
                                cols="30" rows="8" 
                                class="form-control" placeholder="Digite os detalhes do Produto"><?php echo $row['resumo_produto'];?></textarea>
                            </div>
                            ...
                            <hr>
                            <input type="submit" id="atualizar" name="atualizar" id="atualizar" class="btn btn-danger btn-block" value="atualizar">
                        </form>
                    </div>
                </div>
            </div>
